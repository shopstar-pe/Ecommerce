...
using CheckOut.Application.Commands.AppSettingCommand;
...
namespace CheckOut.API.Controllers
{
    ...
    public class AppSettingsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [ProducesResponseType(typeof(AppSettingPaginationViewModel), StatusCodes.Status200OK)]
        ...
        /// <returns></returns>
        [HttpGet("{id}", Name = "GetCheckOutAppSettingById")]
        ...
        public async Task<IActionResult> Post([FromBody]CreateAppSettingCommand command)
        {
            ...
            return this.Created(Url.RouteUrl("GetCheckOutAppSettingById", new { id = response.Id }), new { });
        }
