...
using Catalog.Application.Commands.SellerCommand;
...
namespace Catalog.API.Controllers
{
    ...
    public class SellersController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [ProducesResponseType(typeof(PagedViewModelResult<SellerListViewModel>), StatusCodes.Status200OK)]
        [ProducesDefaultResponseType]
        [Consumes("application/json")]
        public async Task<IActionResult> Get([FromQuery]SellerListQuery query) {
        ...
        {
            var model = await this._mediator.Send(new SellerDetailQuery() { Id = id });
        ...
        {
            var response = await this._mediator.Send(new DeleteSellerCommand { Id = id });
        ...
        [ProducesDefaultResponseType]
        [Consumes("application/json")]
        public async Task<IActionResult> Enable([FromBody]EnableSellerCommand command)
        {
            if (!this.ModelState.IsValid)
                return this.BadRequest(this.ModelState);
        ...
        [ProducesDefaultResponseType]
        [Consumes("application/json")]
        public async Task<IActionResult> Disable([FromBody]DisableSellerCommand command)
        {
            if (!this.ModelState.IsValid)
                return this.BadRequest(this.ModelState);
