...
{
    public class AddProductToCollectionCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        public int ProductId { get; set; }

        public class Handler : IRequestHandler<AddProductToCollectionCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(AddProductToCollectionCommand request, CancellationToken cancellationToken)
            {
                ...
                entity.AddProducts(request.ProductId);
