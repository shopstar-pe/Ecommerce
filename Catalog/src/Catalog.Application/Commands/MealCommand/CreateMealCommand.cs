...
{
    public class CreateMealCommand : IRequest<CommandResult>
    {
        ...
        public class Handler : IRequestHandler<CreateMealCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(CreateMealCommand request, CancellationToken cancellationToken)
            {
                ...
                var entity = Product.Factory.Create(tenantId, seller.SellerId, slug, ProductType.Meal, request.Name, request.Description,
                    request.BasePrice, request.SpecialPrice, null, new List<int> { }, userId);
