...
{
    public class DeleteMealCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<DeleteMealCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DeleteMealCommand request, CancellationToken cancellationToken)
            {
