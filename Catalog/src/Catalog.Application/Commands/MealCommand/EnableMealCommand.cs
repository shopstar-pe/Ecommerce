...
{
    public class EnableMealCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<EnableMealCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(EnableMealCommand request, CancellationToken cancellationToken)
            {
