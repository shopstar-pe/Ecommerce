...
{
    public class DisableCollectionGroupCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<DisableCollectionGroupCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DisableCollectionGroupCommand request, CancellationToken cancellationToken)
            {
                ...
                entity.CollectionGroupStatus = CollectionGroupStatus.Inactive;
