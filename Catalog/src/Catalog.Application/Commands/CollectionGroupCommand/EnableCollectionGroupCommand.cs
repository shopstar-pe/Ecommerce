...
{
    public class EnableCollectionGroupCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<EnableCollectionGroupCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(EnableCollectionGroupCommand request, CancellationToken cancellationToken)
            {
                ...
                entity.CollectionGroupStatus = CollectionGroupStatus.Active;
