...
namespace Ecommerce.API.Proxy.Models
{
    ...
    public class OrderResponseModel
    {
        ...
        public List<OrderItemResponseModel> SaleOrderItems { get; set; }
    }
    ...
    public class OrderItemResponseModel
    {
        ...
        public int SaleOrderId { get; set; }
        public int SaleOrderItemStatus { get; set; }
    ...
    public class OrderRequestModel
    {
        ...
        public ClienRequestModel Customer { get; set; }
        public ShippingAddressRequestModel ShippingAddress { get; set; }
        public List<SaleOrderItemRequestModel> Items { get; set; }
    }

    public class ClienRequestModel
    {
        public string Email { get; set; }
        public string FirstName { get; set; }
        public string LastName { get; set; }
    ...
    public class SaleOrderItemRequestModel
    {
        public int SellerId { get; set; }
        public string SellerName { get; set; }
        public string ProductId { get; set; }
        ...
        public string AdditionalNote { get; set; }
        public decimal Tax { get; set; }
        public List<SaleOrderServiceItemRequestModel> Services { get; set; }
    }

    public class SaleOrderServiceItemRequestModel
    {
    ...
    public class OrderResultResponseModel
    {
