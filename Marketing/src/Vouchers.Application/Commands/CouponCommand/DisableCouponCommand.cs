...
{
    public class DisableCouponCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }

        public class Handler : IRequestHandler<DisableCouponCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DisableCouponCommand request, CancellationToken cancellationToken)
            {
                ...
                entity.CouponStatus = CouponStatus.Inactive;
