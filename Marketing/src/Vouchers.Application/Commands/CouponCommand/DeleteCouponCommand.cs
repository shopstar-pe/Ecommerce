...
{
    public class DeleteCouponCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }

        public class Handler : IRequestHandler<DeleteCouponCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DeleteCouponCommand request, CancellationToken cancellationToken)
            {
