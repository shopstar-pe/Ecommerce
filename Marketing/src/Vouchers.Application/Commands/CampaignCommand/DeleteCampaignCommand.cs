...
{
    public class DeleteCampaignCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<DeleteCampaignCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DeleteCampaignCommand request, CancellationToken cancellationToken)
            {
