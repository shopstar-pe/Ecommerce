...
{
    public class DisableCampaignCommand : IRequest<CommandResult>
    {
        public int Id { get; set; }
        
        public class Handler : IRequestHandler<DisableCampaignCommand, CommandResult>
        {
            ...
            public async Task<CommandResult> Handle(DisableCampaignCommand request, CancellationToken cancellationToken)
            {
                ...
                entity.CampaignStatus = CampaignStatus.Inactive;
