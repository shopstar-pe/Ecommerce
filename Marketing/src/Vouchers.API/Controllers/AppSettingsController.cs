...
using Vouchers.Application.Commands.AppSettingCommand;
...
namespace Vouchers.API.Controllers
{
    ...
    public class AppSettingsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet("{id}", Name = "GetvoucherAppSettingById")]
        ...
        public async Task<IActionResult> Post([FromBody]CreateAppSettingCommand command)
        {
            ...
            return this.Created(Url.RouteUrl("GetvoucherAppSettingById", new { id = response.Id }), new { });
        }
