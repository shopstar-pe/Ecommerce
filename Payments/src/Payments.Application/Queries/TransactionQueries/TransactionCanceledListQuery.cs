...
{
    public class TransactionCanceledListQuery : IRequest<PagedViewModelResult<TransactionListViewModel>>
    {
        ...
        public class Handler : IRequestHandler<TransactionCanceledListQuery, PagedViewModelResult<TransactionListViewModel>>
        {
            ...
            public async Task<PagedViewModelResult<TransactionListViewModel>> Handle(TransactionCanceledListQuery request, CancellationToken cancellationToken)
            {
