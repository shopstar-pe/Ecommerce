...
using Shippings.Application.Commands.AppSettingCommand;
...
namespace Shippings.API.Controllers
{
    ...
    public class AppSettingsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet("{id}", Name = "GetShippingAppSettingById")]
        ...
        public async Task<IActionResult> Post([FromBody]CreateAppSettingCommand command)
        {
            ...
            return this.Created(Url.RouteUrl("GetShippingAppSettingById", new { id = response.Id }), new { });
        }
