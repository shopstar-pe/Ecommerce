...
{
    public class SaleOrderPendingListQuery : IRequest<PagedViewModelResult<SaleOrderListViewModel>>
    {
        ...
        public class Handler : IRequestHandler<SaleOrderPendingListQuery, PagedViewModelResult<SaleOrderListViewModel>>
        {
            ...
            public async Task<PagedViewModelResult<SaleOrderListViewModel>> Handle(SaleOrderPendingListQuery request, CancellationToken cancellationToken)
            {
                var tenantId = this._userIdentityService.GetTenantId();

                var orderStatus = new List<SaleOrderStatus> { };
                orderStatus.Add(SaleOrderStatus.New);
                orderStatus.Add(SaleOrderStatus.Confirmed);
