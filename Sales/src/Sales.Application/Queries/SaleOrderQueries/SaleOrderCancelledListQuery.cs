...
{
    public class SaleOrderCancelledListQuery : IRequest<PagedViewModelResult<SaleOrderListViewModel>>
    {
        ...
        public class Handler : IRequestHandler<SaleOrderCancelledListQuery, PagedViewModelResult<SaleOrderListViewModel>>
        {
            ...
            public async Task<PagedViewModelResult<SaleOrderListViewModel>> Handle(SaleOrderCancelledListQuery request, CancellationToken cancellationToken)
            {
                var tenantId = this._userIdentityService.GetTenantId();

                var orderStatus = new List<SaleOrderStatus> { };
                orderStatus.Add(SaleOrderStatus.Cancelled);
