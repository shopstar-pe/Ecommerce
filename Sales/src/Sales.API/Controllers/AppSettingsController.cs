...
using Sales.Application.Commands.AppSettingCommand;
...
namespace Sales.API.Controllers
{
    ...
    public class AppSettingsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet("{id}", Name = "GetSaleAppSettingById")]
        ...
        public async Task<IActionResult> Post([FromBody]CreateAppSettingCommand command)
        {
            ...
            return this.Created(Url.RouteUrl("GetSaleAppSettingById", new { id = response.Id }), new { });
        }
