...
using Sales.Application.Commands.ClientCommand;
...
namespace Sales.API.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [ProducesResponseType(typeof(PagedViewModelResult<ClientListViewModel>), StatusCodes.Status200OK)]
        ...
        {
            var model = await this._mediator.Send(new ClientDetailQuery() { Id = id });
        ...
        {
            var response = await this._mediator.Send(new DeleteClientCommand { Id = id });
